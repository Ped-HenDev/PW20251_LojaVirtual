...
from sql.produto_repo import criar_tabela_produtos, obter_produto_por_id, obter_produtos_por_pagina
from repo.endereco_repo import criar_tabela_endereco, obter_enderecos_por_pagina
